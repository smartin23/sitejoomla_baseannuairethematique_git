...
//Map
$jmapWidth = $params->get('JmapWidth', '600');
$jmapHeight = $params->get('JmapHeight', '400');
...
<?php if($jmapKeepInView == 1 || (($jmapShowToDirections == 1 || $jmapShowFromDirections == 1) && !empty($jmapDirectionsContainer))) { ?> 
	#jmapRelativeDiv { /* required to avoid jumping */
	  position: relative;
	  width:<?php echo $jmapWidth; ?>px;
	  min-height:<?php echo $jmapHeight; ?>px;
	}
...
<?php }?>
<div id="<?php echo $jmapDivID; ?>" style="width:<?php echo $jmapWidth; ?>px; height:<?php echo $jmapHeight; ?>px;"></div>
<?php if (($jmapShowToDirections == 1 || $jmapShowFromDirections == 1) && !empty($jmapDirectionsContainer)) { ?>
<div id="<?php echo $jmapDirectionsContainer; ?>" style="width:<?php echo $jmapDirWidth; ?>px; height:<?php echo $jmapHeight; ?>px;"></div>
<?php }?>
...
<?php if (!empty($jmapSVOverrideContainer)) { ?>
<div id="<?php echo $jmapSVOverrideContainer; ?>" style="width:<?php echo $jmapWidth; ?>px; height:<?php echo $jmapHeight; ?>px;"></div>
<?php }?>
<?php if($jmapKeepInView == 1 || (($jmapShowToDirections == 1 || $jmapShowFromDirections == 1) && !empty($jmapDirectionsContainer))) { ?> 
		</div>
    </div>
...
//			console.log('JMaps Init Function - ' + mapDiv);
		...
		<?php } ?>
            jQuery(mapDiv).animate({'width': '<?php echo $jmapWidth; ?>px', 'height': '<?php echo $jmapHeight; ?>px'}, function(){
            });
		}
		jmaps_Initialize ();
