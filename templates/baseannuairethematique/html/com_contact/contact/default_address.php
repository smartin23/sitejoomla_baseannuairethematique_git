...
<?php if ($this->contact->telephone && $this->params->get('show_telephone')) : ?>
	<p>
		...
		<span class="contact-telephone">
			<?php echo JText::_('COM_CONTACT_TELEPHONE');?> : <?php echo nl2br($this->contact->telephone); ?>
		</span>
	</p>
<?php endif; ?>
<?php if ($this->contact->fax && $this->params->get('show_fax')) : ?>
	<p>
		...
		<?php echo JText::_('COM_CONTACT_FAX');?> : <?php echo nl2br($this->contact->fax); ?>
		</span>
	</p>
<?php endif; ?>
<?php if ($this->contact->mobile && $this->params->get('show_mobile')) :?>
	<p>
		...
		<span class="contact-mobile">
			<?php echo JText::_('COM_CONTACT_MOBILE');?> : <?php echo nl2br($this->contact->mobile); ?>
		</span>
	</p>
<?php endif; ?>
